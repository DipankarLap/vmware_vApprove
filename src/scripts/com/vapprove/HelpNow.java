...
public class HelpNow extends MobileEngine{

	String projectName			=			"MyVMWareAutomation";
	String moduleName			=			"IOS" + "_" + "I_PHONE";
	String testSetName			=			"SERVICENOW";
	String testScriptName		=			"SERVICENOW";
	...
	public void setTestEnvironment(String env) {
		...
		mobileCapabilities.put("appiumVersion", "1.4.0");
...
System.out.println("ticketCount   "+ticketCount);
			//Clicking on ServiceNow tab
			mobileAppDriver.perform("click", "//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[3]/android.view.View[1]/android.widget.FrameLayout[1]/android.widget.ListView[1]/android.widget.FrameLayout[3]/android.view.View[1]/android.view.View[1]/android.widget.FrameLayout[1]/android.view.View[1]/android.view.View[1]/android.view.View[2]/android.widget.TextView[1]", "Selected  SERVICENOW option from Dashboard screen");
			Thread.sleep(2000);
			mobileAppDriver.perform("captureEntirePageScreenshot", "verifying CONCUR home screen",  "SERVICENOW home screen is displayed sucessfully", "Pass");
...
/*				Thread.sleep(3000);
				...
				mobileAppDriver.perform("click", "//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[3]/android.view.View[1]/android.view.View[1]/android.widget.FrameLayout[1]/android.widget.ListView[1]/android.widget.FrameLayout[1]/android.view.View[1]/android.view.View[1]/android.view.View[2]/android.widget.TextView[1]", "The expense ticket name :" + ticketname1);	
				Thread.sleep(2000);
				//SwipeUp
